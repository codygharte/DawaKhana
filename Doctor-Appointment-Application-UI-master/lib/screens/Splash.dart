  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        ...
        child: Stack(
          children: [
            // Repositioned logo to the top-right corner
            Positioned(
              top: 0, // Positioned at the top of the screen
              right: 20, // Positioned at the rightmost side
              child: Image.asset(
                'assets/images/khana_logo.png',
                width: 800, // Adjusted width for better fit
            ...
            // Doctor image in bottom-right corner
            AnimatedPositioned(
              bottom: 0, // Set to 0 to align with bottom edge of the screen
              right: 0, // Set to 0 to align with right edge of the screen
              duration: const Duration(milliseconds: 400),
              child: AnimatedOpacity(
                duration: const Duration(milliseconds: 400),
                opacity: opacity,
