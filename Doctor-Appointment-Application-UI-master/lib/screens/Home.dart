    ...
    return Scaffold(
      body: SafeArea(
        child: Container(
          ...
          child: Stack(
            children: [
              // Logo in top right corner with updated dimensions
              Positioned(
                top: 3,
                right: 30,
                child: Image.asset(
                  'assets/images/khana_logo.png', // Make sure to add this image to your assets
                  height: 100,
                  width: 300,
                ),
              ),
                      ...
                      Column(
                        ...
                        children: [
                          TextWidget("Hello", 17, Colors.black.withOpacity(.7),
                              FontWeight.bold),
                          TextWidget("VEDANT GHARATE", 25, Colors.black,
                              FontWeight.bold),
                        ],
                      ),
